...
public class PunDecode
{
    public static void main(String[] args) throws Exception
    {
        new PunDecode().decode(args);
    }
    ...
    private void decode(String[] args) throws Exception
    {
        ...
        File file = new File("/mnt/c/Users/Anssi/Workspace/linguistics/lidia-project/wsd_input.txt");
        // reader = new BufferedReader(new InputStreamReader(System.in));
        reader = new BufferedReader(new FileReader(file));

        // writer = new BufferedWriter(new OutputStreamWriter(System.out));
        writer  = new FileWriter("/mnt/c/Users/Anssi/Workspace/linguistics/lidia-project/wsd_output.txt"); 
